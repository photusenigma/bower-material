...
MdConstantFactory.$inject = ["$sniffer"];angular.module('material.core')
...
mdCompilerService.$inject = ["$q", "$http", "$injector", "$compile", "$controller", "$templateCache"];angular
  .module('material.core')
...
generateAllThemes.$inject = ["$injector"];angular.module('material.core.theming', ['material.core.theming.palette'])
...
MdAutocompleteCtrl.$inject = ["$scope", "$element", "$mdUtil", "$mdConstant", "$mdTheming", "$window", "$animate", "$rootElement", "$attrs", "$q"];angular
...
MdChipsCtrl.$inject = ["$scope", "$mdConstant", "$log", "$element", "$timeout"];angular
    .module('material.components.chips')
...
"use strict";
 ...
 MdIconService.$inject = ["config", "$http", "$q", "$log", "$templateCache"];angular
    .module('material.components.icon' )
